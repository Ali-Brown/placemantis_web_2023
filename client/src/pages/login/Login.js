...
import PostAjaxDailogue from '../../components/dialogues/PostAjaxDialogue';
...
class Login extends Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        if (prevProps.sideEffectLoading && this.props.sideEffectLoading === false && this.state.formGroup === "login") {
            this.setState({showForm: false, showDialogue: true})
        }
        
        if (prevProps.sideEffectLoading && this.props.sideEffectLoading === false && this.state.formGroup === 'confirm' && this.props.successMessage === "User Confirmed") {
            this.setState({
                showForm: true,
                showDialogue: false,
        ...
        if (prevProps.sideEffectLoading && this.props.sideEffectLoading === false && this.state.formGroup === "reset"  && this.props.successMessage === "User Password Reset"/* this.props.sideEffectLoading === false && this.state.formGroup === 'reset' && this.props.successMessage === "User Password Reset" */) {
            this.setState({
                showForm: false,
                showDialogue: true
            })
                    ...
                    <div className={classes.form}>
                        ...
                        {this.state.showDialogue ? 
                            <PostAjaxDailogue 
                                ...
                                successType1='Start Mission'
                                successButton1Clicked={this.handleDialogueButtonClicked}
                                successHeading={this.props.successMessage}
                                failHeading={this.props.failMessage}
                                failType1='Try Again'
                                failButton1Clicked={this.retryLogin}
                                formGroup={this.state.formGroup}
                            /> 
                            : 
                            null
