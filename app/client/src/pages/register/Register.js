                    ...
                    <div className={classes.form}>
                        ...
                        {this.state.showDialogue ? 
                            <PostAjaxDailogue 
                                ...
                                hasSecondSuccessButton={true}
                                hasSecondFailButton={false}
                                successType1='Login'
                                successButton1Clicked={this.goToLogin}
                                successType2='Home'
                                successButton2Clicked={this.goToHome}
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        onResetUsernameAvailabilty: () => dispatch(actions.resetUsernameAvailabilty()),
